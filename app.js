...
// BUDGET CONTROLLER
var budgetController = (function (data) {
    //console.log(data)
    ...
    return {
        ...
        calculatePercentages: function () {
            data.allItems.exp.forEach(function (cur) {
                var expense = new Expense(cur.id, cur.value, cur.description);
...
var controller = (function (budgetCtrl, UICtrl, storageCtrl) {
    ...
    var updateBudget = function () {
        ...
        UICtrl.displayBudget(storageCtrl.data);
    };
    ...
    var ctrlAddItem = function () {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            // 7. Set data to localstorage
            budgetCtrl.setDataToLocalStorage();
        }
    };
    ...
    return {
        init: function () {
            ...
            console.log(storageCtrl.data)
            var storagedData = storageCtrl.data;

            if (storagedData.percentage !== -1) {
                // for each entry from json object | inc | exp
                storagedData.allItems.exp.forEach(function (cur) {
                    UICtrl.addListItem(cur, 'exp')
                });

                storagedData.allItems.inc.forEach(function (cur) {
